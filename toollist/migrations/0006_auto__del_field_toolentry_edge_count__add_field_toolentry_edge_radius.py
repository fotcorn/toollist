...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ToolEntry.edge_radius'
        db.add_column(u'toollist_toolentry', 'edge_radius',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ToolEntry.edge_radius'
        db.delete_column(u'toollist_toolentry', 'edge_radius')
